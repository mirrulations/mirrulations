class PathGenerator:
    ...
    following our data structure where every path is based on an agencyId, 
    id, docketId and type
    Paths are generated by extracting information from a dockets, documents or comments 
    .json file
    Important Keys:
    ----------
